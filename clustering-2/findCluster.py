...
while True:
    ...
    if ((frame_number%RATIO_FRAMES)==0):
        ...
        for face_encoding in face_encodings:
            ...
            if (area < (90*90)):
                print ("ANALYZE",";",frame_number,";","NOBODY - Tam Area",";",RATIO_FRAMES,";",length)
                continue
            ...
            if (len(face_distances)<=0):
                ...
                print ("ANALYZE",";",frame_number,";","NOBODY - Faces minus 0",";",RATIO_FRAMES,";",length)
                continue
            ...
            if (min(face_distances)<=TOLERANCIA):
                ...
                print ("ANALYZE",";",frame_number,";",name,";",RATIO_FRAMES,";",length)
            else:
                known_faces.append(face_encoding)
